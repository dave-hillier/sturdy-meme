...
# For restricted environments (claude triplet), override FEATURE_OPTIONS entirely
# to disable windowing backends that need dev packages not available in the sandbox
if ("${TARGET_TRIPLET}" STREQUAL "x64-linux-claude")
    set(FEATURE_OPTIONS
        -DSDL_ALSA=OFF
        -DSDL_IBUS=OFF
        -DSDL_VULKAN=ON
