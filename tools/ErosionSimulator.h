...
// Erosion simulator for preprocessing - generates water placement data from heightmap
// This is a tool-only header; the engine uses ErosionDataLoader to load cached results
...
// Include shared data types from engine
#include "../src/WaterPlacementData.h"
