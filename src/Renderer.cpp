...
bool Renderer::init(SDL_Window* win, const std::string& resPath) {
    ...
    // Load erosion/water placement data from cache (generated by erosion_preprocess tool)
    ...
    if (erosionSimulator.isCacheValid(erosionConfig)) {
        if (erosionSimulator.loadFromCache(erosionConfig)) {
            ...
            SDL_LogWarn(SDL_LOG_CATEGORY_APPLICATION, "Failed to load erosion cache");
        }
    } else {
        SDL_LogWarn(SDL_LOG_CATEGORY_APPLICATION,
            "Erosion cache not found. Run erosion_preprocess tool to generate water placement data.");
    }
